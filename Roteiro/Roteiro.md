...
E antes que me julguem dizendo que no VSCode é melhor, o que já quero mostrar nesse começo que todo o conteúdo aqui exibido é a tentativa de unir o melhor dos dois mundos, uma vez que existe plugin de várias IDEs como InteliJ, VSCode para que seja usado todos os comandos do VIM nos seus modos de operação dentro dele. (EXEMPLO)
